...
git push
git checkout -b dasgoclient-v02.04.40
git branch -l
...
# test new client
cp w820/slc7_amd64_gcc820/cms/dasgoclient/v02.04.40/bin/dasgoclient .
...
# push changes
git push -u origin dasgoclient-v02.04.40

# finally make pull request

# delete local branch (named newfeature)
git branch -d dasgoclient-v02.04.40
# delete remote branch (named newfeature)
git push origin :dasgoclient-v02.04.40
